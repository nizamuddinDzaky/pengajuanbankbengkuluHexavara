<div class="dokumenMultigunaPensiun">
    <div class="row">
        <div class="col-md-6">
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="form-group">
                <label for="noktp">SK CAPEG (CPNS) <span class="red">*</span></label>
                <div class='content'>
                    <!-- Dropzone -->
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="form-group">
                <label for="noktp"> SK Pensiun <span class="red">*</span></label>
                <div class='content'>
                    <!-- Dropzone -->
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="noktp">Kartu Identitas Pensiun <span class="red">*</span></label>
                <div class='content'>
                    <!-- Dropzone -->
